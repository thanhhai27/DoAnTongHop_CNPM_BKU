...
<body>
    <div id="wrapper">
        ...
        <form action="/check_cli_register" method="POST">
            ...
            <div class="form-return">
                <input type="submit" value="Quay lại trang đăng nhập" class="return" onclick="window.location.href='/authentic/cli_login'">
            </div>
        </div>
    </div>
</body>
